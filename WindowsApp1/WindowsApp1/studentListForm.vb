...
Public Class studentListForm
    ...
    Private Sub femalePanel_Paint(sender As Object, e As PaintEventArgs) Handles femalePanel.Paint

    End Sub

    Private Sub maleLabel_Click(sender As Object, e As EventArgs) Handles maleLabel.Click

    End Sub

    Private Sub femaleLabel_Click(sender As Object, e As EventArgs) Handles femaleLabel.Click
